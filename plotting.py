...
if __name__ == '__main__':
    ...
    # for lr in [0.00045, 0.00046, 0.00047, 0.00048, 0.00049, 0.00051, 0.00052, 0.00053, 0.00054, 0.00055]:           
    
    
    
# for lr in [0.0041, 0.0042, 0.0043, 0.0044, 0.0046, 0.0047, 0.0048, 0.0049, 0.0051, 0.0052]:                                                                                                                                                                                                                                                                                            
    for lr in [0.00045, 0.00046, 0.00047, 0.00048, 0.00049, 0.00051, 0.00052, 0.00053, 0.00054, 0.00055]:
        with open(os.getcwd() +'\simulations\simulationsQ3\{}\{}_policy_sim_lr={}_sv=0.0051.npy'.format(env_name, env_name, lr), 'rb') as f:
